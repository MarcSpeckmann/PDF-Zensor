...
class PDFUtilsTest {
	...
	/**
	 * PDType3Font for testing
	 */
	private static PDType3Font pdType3Font;
	...
	static class TextPositionValue {
		...
		TextPositionValue(float endX, float endY, float fontSize, int fontSizeInPt, float maxHeight, float individualWidth, float spaceWidth, String unicode, int[] charCodes, PDFont font) {
			this.endX = endX;
			this.endY = endY;
	...
	private static TextPositionValue tpValue1 = new TextPositionValue(79.19946f, 800.769f, 10.9091f, 10, 7.51637f, 8.333466f, 3.0545478f, "D", new int[]{68}, PDType1Font.TIMES_ROMAN);
	private static TextPositionValue tpValue2 = new TextPositionValue(23.1547f, 44.32212f, 11.95f, 11, 7.51637f, 8.333466f, 3.0545478f, "DE", new int[]{68, 69}, PDType1Font.TIMES_ROMAN);
	// TODO: Initialize PDType3Font...
	private static TextPositionValue tpValue3 = new TextPositionValue(79.19946f, 800.769f, 10.9091f, 10, 7.51637f, 8.333466f, 3.0545478f, "D", new int[]{68}, pdType3Font);
	...
	static {
		...
		// test with PDType3Font
		// TEXTPOSITION.put(new Rectangle2D.Float(tpValue3.endX, tpValue3.endY, 7.876370270042557f, 9.796371887116607f), tpValue3);
		// TODO: not working yet because I can't initialize a PDType3Font
	}
	...
	void transformTextPositionTest(@NotNull TextPositionValue input, @NotNull Rectangle2D expected) {
		...
		TextPosition tp = new TextPosition(0, 595.276f, 841.89f, new Matrix(input.fontSize, 0f, 0f, input.fontSize, input.endX, input.endY), input.endX, input.endY, input.maxHeight, input.individualWidth, input.spaceWidth, input.unicode, input.charCodes, input.font, input.fontSize, input.fontSizeInPt);
		try {
