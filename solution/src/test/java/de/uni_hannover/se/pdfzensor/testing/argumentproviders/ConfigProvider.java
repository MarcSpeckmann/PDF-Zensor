...
public class ConfigProvider implements ArgumentsProvider {
	...
	private static Arguments createArgument(@Nullable String configName, @Nullable String out, @Nullable Level lvl,
		...
		return Arguments.of(config, outFile, lvl, mode, expressions, colors);
	}
	...
	public Stream<? extends Arguments> provideArguments(final ExtensionContext extensionContext) {
		...
		list.add(createArgument(null, null, null, null, null, null));
		...
		for (var col : expectedColorsForConfig.entrySet())
			list.add(createArgument(col.getKey(), null, null, null, expectedExpressionForConfig.get(col.getKey()),
									col.getValue()));
		for (var exp : expectedExpressionForConfig.entrySet())
			list.add(createArgument(exp.getKey(), null, null, null, exp.getValue(),
